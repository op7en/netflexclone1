...
const ProfileMenu = ({ onLogout }) => {
  ...
  return (
<<<<<<< HEAD
    <div ref={ref} className="navbar-profile" onClick={() => setOpen(p => !p)}>
      <svg 
        className={`avatar-icon`} 
        xmlns="http://www.w3.org/2000/svg" 
        width={36} height={36} fill={"#ffffff"} viewBox="0 0 24 24">
      ...
      <svg 
        ...
        xmlns="http://www.w3.org/2000/svg" 
        width={20} height={20} fill={"#ffffff"} viewBox="0 0 24 24">
=======
    <div
      ref={ref}
